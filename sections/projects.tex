...
\multicolumn{2}{@{}X@{}}{How does our brain structure information? Can we represent the brain activity through geometric modeling? We explore the geometric representations of cognition, such as: neural manifolds, i.e. the smooth spaces of neuronal activity found in neuronal circuits such as head direction circuits, grid cells, and place cells, neural representations, i.e. the structures formed by the activations of visual stimuli ("images") in the visual cortex.}  \\
\end{tabularx}
